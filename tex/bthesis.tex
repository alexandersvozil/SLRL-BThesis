...
Then heuristic algorithms using tabu search and simulated annealing will be introduced and their performances will be evaluated in comparison with the old algorithm proposed 
